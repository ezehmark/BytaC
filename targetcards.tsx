...
const targetCards = [
  { name: "Target Card (100 to 199)", uri:'https://i.postimg.cc/ZY6n3ckY/images-24.png'},

  { name: "USA Target Card (200 and above)", uri:'https://i.postimg.cc/ZY6n3ckY/images-24.png'},
...
const TargetCards: React.FC<targetProps> = ({ isList, toggleCardList, onSelectCard }) => {
