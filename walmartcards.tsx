...
const walmartCards = [
  { name: "USA Walmart E-code (300)", uri: 'https://i.postimg.cc/66LgCJTj/images-20.png'},

  { name: "USA Walmart E-code (50 to 299)", uri: 'https://i.postimg.cc/66LgCJTj/images-20.png'},

  { name: "USA Walmart Pysical  (100 to 299)", uri: 'https://i.postimg.cc/66LgCJTj/images-20.png'},

  { name: "USA Walmart E-code (300)", uri: 'https://i.postimg.cc/66LgCJTj/images-20.png'},

  { name: "USA Physical (300 and above)", uri: 'https://i.postimg.cc/66LgCJTj/images-20.png'},

  { name: "USA Walmart Physical (50 to 99)", uri: 'https://i.postimg.cc/66LgCJTj/images-20.png'},

];


const WalmartCards: React.FC<walmartProps> = ({ isList, toggleCardList, onSelectCard }) => {
