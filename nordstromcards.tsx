...
const nordCards = [
  { name: "USA Nordstrom E-code (300 to 500)", uri:'https://i.postimg.cc/15D0Y6LJ/images-22.png'},

  { name: "USA Nordstrom E-code (501 and above)", uri:'https://i.postimg.cc/15D0Y6LJ/images-22.png'},

  { name: "USA Nordstrom E-code (50 to 299)", uri:'https://i.postimg.cc/15D0Y6LJ/images-22.png'},

  { name: "USA Nordstrom Physical (100 to 299)", uri:'https://i.postimg.cc/15D0Y6LJ/images-22.png'},

  { name: "USA Nordstrom Physical (300 to 500)", uri:'https://i.postimg.cc/15D0Y6LJ/images-22.png'},

  { name: "USA Nordstrom Physical (50 to 99)", uri:'https://i.postimg.cc/15D0Y6LJ/images-22.png'},

  { name: "USA Nordstrom Physical (501 and above)", uri:'https://i.postimg.cc/15D0Y6LJ/images-22.png'},
...
const NordstromCards: React.FC<nordProps> = ({ isList, toggleCardList, onSelectCard }) => {
