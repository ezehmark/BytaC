...
const airtelPlans = [
  { name: "100MB (Weeekly) = ₦85",uri:'https://i.postimg.cc/ydt1W52m/images-13.png'},

  {name: "300MB (Weekly) = ₦120",uri:'https://i.postimg.cc/ydt1W52m/images-13.png'},

  {name: "500MB (Monthly) = ₦155",uri:'https://i.postimg.cc/ydt1W52m/images-13.png'},

  {name: "1GB (Monthly) = ₦295",uri:'https://i.postimg.cc/ydt1W52m/images-13.png'},

  {name: "2B (Monthky) = ₦590",uri:'https://i.postimg.cc/ydt1W52m/images-13.png'},

  {name: "5GB (Monthly) = ₦1,475",uri:'https://i.postimg.cc/ydt1W52m/images-13.png'},
...
const AirtelPlans: React.FC<airtelProps> = ({ isList, toggleCardList, onSelectCard }) => {
