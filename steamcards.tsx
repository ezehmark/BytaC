...
const steamCards = [
  { name: "USA Steam E-code", uri:'https://i.postimg.cc/hvLBdf6p/images-34-1.jpg'},
  { name: "USA Steam Physical", uri:'https://i.postimg.cc/hvLBdf6p/images-34-1.jpg'},

  { name: "UK Steam E-code", uri:'https://i.postimg.cc/hvLBdf6p/images-34-1.jpg'},

  { name: "UK Steam Physical", uri:'https://i.postimg.cc/hvLBdf6p/images-34-1.jpg'},



{ name: "Euro Steam E-code", uri:'https://i.postimg.cc/hvLBdf6p/images-34-1.jpg'},

{ name: "Euro Steam Physical", uri:'https://i.postimg.cc/hvLBdf6p/images-34-1.jpg'},
...
const SteamCards: React.FC<steamProps> = ({ isList, toggleCardList, onSelectCard }) => {
